...
class ImportRegimenesFiscalesSeeder extends Seeder{
...
//        $file = 'public/csv/_viAlumnos.csv';
        $file = 'public/csv/_vi_cat_regimen_fiscal_sat.csv';
            ...
            try{
                ...
                if ($dupla[0] !== 'Undefined' ) {
                    ...
                    RegimenFiscal::create([
                        'clave_regimen_fiscal' => $arr[1] ?? '',
                        'regimen_fiscal' => utf8_encode(trim($arr[2])) ?? '',
                        'old_regimen_fiscal_id' => (int) ($arr[0] ?? 0),
                    ]);
