				...
				<div class="w-full">
					...
					<form @submit.prevent="submit">
						<div>
							...
							<TextInput id="nombre" type="text" class="block w-full mt-1" v-model="form.nombre" required autofocus autocomplete="nombre" />
							<InputError class="mt-2" :message="form.errors.nombre" />
						</div>

                        <div>
                            <InputLabel for="username" value="username" />
                            <TextInput id="username" type="text" class="block w-full mt-1" v-model="form.username" required autocomplete="username" />
